...
var tableClient = azure.createTableService(process.env.CONNECTION_STRING || 'UseDevelopmentStorage=true');
var blobClient = azure.createBlobService(process.env.CONNECTION_STRING || 'UseDevelopmentStorage=true')
